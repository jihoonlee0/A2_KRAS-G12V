...
# Log file 'X:/user/jwlee/peptides/stuff_for_jihoon_2022-05-11/EDST/TCR-pMHC-viz.tcl', created by user Jihoon
proc viz_mol {file} {
    ...
    mol addrep $molID
    mol modselect 2 $molID resid 678 or resid 679 or resid 680 or resid 681
...
set pdb_files [glob -nocomplain -directory X:/user/jwlee/peptides/stuff_for_jihoon_2022-05-11/EDST/ {*A2KRAS02*.pdb}]
